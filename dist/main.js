...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://webpack5-boilerplate-2022/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\n\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://webpack5-boilerplate-2022/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\n\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://webpack5-boilerplate-2022/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\n\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://webpack5-boilerplate-2022/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"fetchData\": () => (/* binding */ fetchData)\n/* harmony export */ });\n/* harmony import */ var _addContents_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addContents.js */ \"./src/addContents.js\");\n/* harmony import */ var _filter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filter.js */ \"./src/filter.js\");\n\n\n\n\nfunction fetchData(url, classCategory, quizCategory, isClass, isQuiz, classWrapper, quizWrapper) {\n    fetch(url)\n      .then(function (response) {\n        return response.json()\n      })\n      .then(function(data) {\n        if(isClass) {\n          if (classCategory == 'all') {\n            (0,_addContents_js__WEBPACK_IMPORTED_MODULE_0__.addClassContents)(data, classWrapper, classCategory);\n          }\n          else if (classCategory == 'help') {\n            let filtered = (0,_filter_js__WEBPACK_IMPORTED_MODULE_1__.filterClass)(data, classCategory);\n            (0,_addContents_js__WEBPACK_IMPORTED_MODULE_0__.addClassContents)(filtered, classWrapper, classCategory);\n          }\n          else if (classCategory == 'git') {\n            let filtered = (0,_filter_js__WEBPACK_IMPORTED_MODULE_1__.filterClass)(data, classCategory);\n            (0,_addContents_js__WEBPACK_IMPORTED_MODULE_0__.addClassContents)(filtered, classWrapper, classCategory);\n          }\n          else if (classCategory == 'recent') {\n            let filtered = (0,_filter_js__WEBPACK_IMPORTED_MODULE_1__.filterClass)(data, classCategory);\n            (0,_addContents_js__WEBPACK_IMPORTED_MODULE_0__.addClassContents)(filtered, classWrapper, classCategory);\n          }\n        }\n        else if (isQuiz) {\n          if (quizCategory === 'all') {\n            (0,_addContents_js__WEBPACK_IMPORTED_MODULE_0__.addQuizContents)(data, isQuiz, quizWrapper);\n          }\n          else if (quizCategory === 'git') {\n            let filtered = (0,_filter_js__WEBPACK_IMPORTED_MODULE_1__.filterQuiz)(data, quizCategory);\n            (0,_addContents_js__WEBPACK_IMPORTED_MODULE_0__.addQuizContents)(filtered, isQuiz, quizWrapper);\n          }\n        } \n      })\n}\n\n\n\n//# sourceURL=webpack://webpack5-boilerplate-2022/./src/fetch.js?");
